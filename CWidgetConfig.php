...
use Modules\EnhancedProblems\Actions\Widgets\EnhancedProblemsForm;
...
class CWidgetConfig {
	...
	public static function getKnownWidgetTypes(string $context): array {
		$types = [
			...
			EnhancedProblemsForm::WIDGET_TYPE => _('Enhanced Problems')
		];
	...
	public static function getJSClasses(): array {
		return [
			...
			EnhancedProblemsForm::WIDGET_TYPE => 'CWidgetEnhancedProblems'
		];
	}
	...
	private static function getDefaultDimensions(): array {
		return [
			...
			EnhancedProblemsForm::WIDGET_TYPE => ['width' => 12,  'height' => 5]
		];
	}
	...
	public static function getDefaultRfRate(string $type): int {
		switch ($type) {
			...
			case WIDGET_WEB:
			case EnhancedProblemsForm::WIDGET_TYPE:
				return SEC_PER_MIN;
	...
	public static function getForm(string $type, string $data, ?string $templateid): CWidgetForm {
		switch ($type) {
			...
			case EnhancedProblemsForm::WIDGET_TYPE:
				return new EnhancedProblemsForm($data, $templateid);
